...
class ImagePainterState extends State<ImagePainter> {
                              ...
                              return Padding(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(child: Text("Aa", style: fontTextList[i])),
                                  ),
                                ),
                              );
                            },
  ...
  void _addEndPoints() =>
      _addPaintHistory(PaintInfo(offset: <Offset?>[_start, _end], painter: _painter, mode: _controller.value.mode));

  void _addFreeStylePoints() =>
      _addPaintHistory(PaintInfo(offset: <Offset?>[..._points], painter: _painter, mode: PaintMode.freeStyle));
            ...
            widget.applyFilters == false
                ...
                : ValueListenableBuilder<bool>(
                    ...
                    builder: (_, controller, __) {
                      return IconButton(
                        icon: Icon(
                          upAndDown.value == false ? Icons.keyboard_arrow_down : Icons.keyboard_arrow_up,
                          color: Colors.white,
                        ),
                        onPressed: () {
