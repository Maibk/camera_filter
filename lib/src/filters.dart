          ...
          builder: (context, constraints) {
            ...
            return Stack(
              ...
              children: [
                ...
                widget.onVideoFilter == true ? Container() : _buildSelectionRing(itemSize),
              ],
            );
          },
        );
          ...
          child: SizedBox(
            ...
            child: const DecoratedBox(
              decoration: BoxDecoration(
                ...
                border: Border.fromBorderSide(BorderSide(width: 6.0, color: Colors.white)),
              ),
            ),
          ),
        ),
...
class CarouselFlowDelegate extends FlowDelegate {
  CarouselFlowDelegate({required this.viewportOffset, required this.filtersPerScreen}) : super(repaint: viewportOffset);
