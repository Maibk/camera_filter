...
class CameraScreenPlugin extends StatefulWidget {
  ...
  Widget? profileIconWidget, cameraFlipIcon, flashIcon;
...
class _CameraScreenState extends State<CameraScreenPlugin> with TickerProviderStateMixin, WidgetsBindingObserver {
  ...
  final _filters = [
    Colors.transparent,
    ...List.generate(Colors.primaries.length, (index) => Colors.primaries[(index) % Colors.primaries.length]),
  ];
  ...
  void initState() {
    ...
    controller = AnimationController(vsync: this, duration: const Duration(seconds: 3500))
      ..addListener(() async {
        setState(_updateScale);
      });
    _rotationController = AnimationController(vsync: this, duration: Duration(seconds: 5))
      ..addListener(() {
      ...
      child: _initializeControllerFuture == null
          ...
          : Stack(
              children: [
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(color: Colors.black.withAlpha(86), shape: BoxShape.circle),
                ...
                //           ? Container()
                //           : Text(
                //               time.value == "" ? "" : formatHHMMSS(int.parse(time.value)),
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        GestureDetector(
                          child: SizedBox(child: widget.cameraFlipIcon),
                          onTap: () {
